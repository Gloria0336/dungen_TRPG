    ...
    skillSet: [
      {
        ...
        desSpImpactLevel: '低', durabilityTarget: '下',
        hitRule: '基礎命中70%', effectSummary: '束縛下半身；玩家 AGI 與閃避下降，每回合額外扣除微量 SP',
        baseHit: 70,
      },
    ],
    ...
    skillSet: [
      {
        ...
        desSpImpactLevel: '中', durabilityTarget: '無',
        hitRule: '基礎命中60%', effectSummary: '大幅增加 DES，並使玩家下回合命中率下降 30%',
        baseHit: 60,
      },
    ],
    ...
    skillSet: [
      {
        ...
        desSpImpactLevel: '中', durabilityTarget: '雙',
        hitRule: '基礎命中85%', effectSummary: '快速的三連擊，大幅削減上下半身裝備耐久',
        baseHit: 85,
      },
      {
        id: 'MS-B7-B', name: '影之束縛', control: true,
        desSpImpactLevel: '高', durabilityTarget: '無',
        hitRule: '基礎命中65%', effectSummary: '陰影化為觸手束縛全身，持續 1 回合',
        baseHit: 65,
      },
    ],
    ...
    skillSet: [
      {
        ...
        desSpImpactLevel: '中', durabilityTarget: '雙',
        hitRule: '基礎命中75%', effectSummary: '造成持續燃燒效果，每回合扣除 HP 並隨機損壞裝備部位',
        baseHit: 75,
      },
    ],
    ...
    skillSet: [
      {
        ...
        desSpImpactLevel: '高', durabilityTarget: '無',
        hitRule: '基礎命中70%', effectSummary: '造成中量物理傷害並施加『麻痺』狀態',
        baseHit: 70,
      },
      {
        id: 'MS-B9-B', name: '卵管侵入', control: true,
        desSpImpactLevel: '極高', durabilityTarget: '下',
        hitRule: '基礎命中60%', effectSummary: '強行將產卵管插入下半身孔穴，持續注入毒素與幼蟲',
        baseHit: 60,
      },
    ],
    ...
    skillSet: [
      {
        ...
        desSpImpactLevel: '高', durabilityTarget: '雙',
        hitRule: '基礎命中75%', effectSummary: '蛇身死死纏繞玩家，每回合造成固定傷害並損毀裝備',
        baseHit: 75,
      },
      {
        id: 'MS-C3-B', name: '淫靡凝視', control: true,
        desSpImpactLevel: '極高', durabilityTarget: '無',
        hitRule: '基礎命中65%', effectSummary: '石化玩家的理智，使其無法行動',
        baseHit: 65,
      },
      {
        id: 'MS-C3-ULT', name: '女王的育苗床', control: true,
        desSpImpactLevel: '極高', durabilityTarget: '下',
        hitRule: '條件觸發', effectSummary: '啟動 SPECIAL，強制進入產卵寄生流程',
        baseHit: 100,
      },
    ],
